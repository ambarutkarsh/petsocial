...
import { ChevronRight, Grid3X3, LogOut, Trash2 } from "lucide-react";
  ...
  return (
    <MobileLayout>
      <PageWrapper noPadding>
        ...
        <div className="h-[155px] relative" style={{ background: "linear-gradient(135deg, #7B5EA7 0%, #7B5EA7 50%, #FF8C66 100%)" }}>
