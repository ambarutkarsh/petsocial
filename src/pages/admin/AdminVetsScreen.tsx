                ...
                <tr key={v.id} className="border-t" style={{ borderColor: "#F0EDF5" }}>
                  ...
                  <td className="px-4 py-3">
                    <div className="flex justify-end gap-2 flex-wrap">
                      ...
                      <button onClick={() => openEdit(v)} className="text-[11px] px-2.5 py-1 rounded-full border bg-white inline-flex items-center gap-1" style={{ borderColor: "#E8E5F0" }}>
                ...
                <div className="flex flex-wrap gap-2">
                  {SPEC_OPTIONS.map((s) => (
                    <button
                      ...
                      style={form.specialisations.includes(s) ? {} : { borderColor: "#E8E5F0" }}
                    >
                      {s}
                    </button>
                  ))}
