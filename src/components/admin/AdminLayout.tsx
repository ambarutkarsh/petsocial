  ...
  return (
    <div className="min-h-screen" style={{ background: "#F5F5F5" }}>
      ...
      <aside
        ...
        style={{ background: "#FFFFFF", borderRight: "1px solid #E8E5F0", paddingTop: 80 }}
      >
        <nav className="flex-1 flex flex-col">
          {NAV.map((item) => {
            ...
            return (
              <NavLink
                ...
                style={({ isActive }) =>
                  isActive
                    ? { background: "#F0EBFF", color: "#7B5EA7", borderLeft: "3px solid #7B5EA7" }
                    : { color: "#6B6880" }
                }
              >
          ...
          <div className="my-3 mx-5 border-t" style={{ borderColor: "#E8E5F0" }} />
          {NAV_BOTTOM.map((item) => {
            const Icon = item.icon;
            return (
              <NavLink
      ...
      <nav className="md:hidden fixed bottom-0 left-0 right-0 bg-white border-t flex z-20" style={{ borderColor: "#E8E5F0" }}>
        {[...NAV, ...NAV_BOTTOM].map((item) => {
          ...
          return (
            <NavLink
              ...
              style={({ isActive }) => ({ color: isActive ? "#7B5EA7" : "#6B6880" })}
            >
