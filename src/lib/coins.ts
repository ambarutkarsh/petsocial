...
export function showCoinAnimation(amount: number) {
  ...
  el.setAttribute(
    "style",
    "position:fixed;top:30%;left:50%;transform:translateX(-50%);z-index:9999;font-family:'Cormorant Garamond',serif;font-weight:900;font-size:32px;color:#1B2A4A;text-shadow:0 2px 8px rgba(27,42,74,0.3);pointer-events:none;animation:coinPop 1.5s ease-out forwards;",
  );
