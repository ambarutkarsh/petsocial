...
export function showCoinAnimation(amount: number) {
  ...
  el.setAttribute(
    "style",
    "position:fixed;top:30%;left:50%;transform:translateX(-50%);z-index:9999;font-family:'Playfair Display',serif;font-weight:900;font-size:32px;color:#2D4A3E;text-shadow:0 2px 8px rgba(45,74,62,0.3);pointer-events:none;animation:coinPop 1.5s ease-out forwards;",
  );
